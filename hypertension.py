...
## Files for pressure
xdmffile_p1 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/p1.xdmf')
xdmffile_p2 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/p2.xdmf')
xdmffile_p3 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/p3.xdmf')

## Files for darcy velocity

xdmffile_v1 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/v1.xdmf')
xdmffile_v2 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/v2.xdmf')
xdmffile_v3 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/v3.xdmf')

## Files for concentration

xdmffile_c1 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/c1.xdmf')
xdmffile_c2 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/c2.xdmf')
xdmffile_c3 = XDMFFile(mesh.mpi_comm(), 'hypertension_results/c3.xdmf')

# Importing initial pressure

path = "Files/hypertension_pressure2.csv"
df = pd.read_csv(path,names=['time','pressure'])

# Fixing units
time = np.array(df['time'])
pressure = np.array(df['pressure']) # Kpa, 0.133322368 mmHg = 1 Kpa

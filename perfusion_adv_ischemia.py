...
## Files for pressure
xdmffile_p1 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/p1.xdmf')
xdmffile_p2 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/p2.xdmf')
xdmffile_p3 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/p3.xdmf')

## Files for darcy velocity

xdmffile_v1 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/v1.xdmf')
xdmffile_v2 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/v2.xdmf')
xdmffile_v3 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/v3.xdmf')
...
xdmffile_c1 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/c1.xdmf')
xdmffile_c2 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/c2.xdmf')
xdmffile_c3 = XDMFFile(mesh.mpi_comm(), 'perfusion_adv_ischemia_results/c3.xdmf')

...
## Files for pressure
xdmffile_p1 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/p1.xdmf')
xdmffile_p2 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/p2.xdmf')
xdmffile_p3 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/p3.xdmf')

## Files for darcy velocity

xdmffile_v1 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/v1.xdmf')
xdmffile_v2 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/v2.xdmf')
xdmffile_v3 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/v3.xdmf')
...
xdmffile_c1 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/c1.xdmf')
xdmffile_c2 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/c2.xdmf')
xdmffile_c3 = XDMFFile(mesh.mpi_comm(), 'test_multi_adv_results/c3.xdmf')
...
R_12 = Constant(0.20) # Rate consentration rate
R_23 = Constant(0.20)  # Rate consentration rate
...
F2 = ((c1 - c_n1) / k)*v1*dx + dot(v_d1, grad(c1))*v1*dx - D*dot(grad(c1),grad(v1))*dx + \
     ...
     (c1+R_12*c_n1)*v1*dx + (c2-R_12)*v2*dx + (c2+R_23*c_n2)*v2*dx +(c3-R_23*c_n2)*v3*dx
#     R_12*c1*(v1-v2)*dx + R_23*c2*(v2-v3)*dx
